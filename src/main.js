...
function createHTML() {
  ...
  app.innerHTML = `
    ...
    <footer class="footer">
      <p>Made by <a href="https://hyowonwang.netlify.app/" target="_blank" rel="noopener noreferrer">Hyowon Wang<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="margin-left: 0.25rem; vertical-align: middle;">
